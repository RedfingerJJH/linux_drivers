...
#define SECOND_MAJOR 230 /* Device or resource busy */
...
void second_timer_handler(struct timer_list *s_timer)
{
...
static void second_setup_cdev(struct second_dev *dev, int index)
{
	...
	if (err)
		printk(KERN_INFO "Failed to add second device");
}
...
MODULE_AUTHOR("JJH <jjh.2004@gmail.com>");
